      ...
      <View style={styles.headerview}>
        <View style={styles.view1}>
          ...
          <Image
            ...
            source={require("../assets/icons/expand_arrow_120px.png")}
          />
        </View>
      ...
      >
        <View style={styles.imageviews}>
          <View style={styles.shadowview}>
            <Image
              source={require("../assets/images/raisins_and_banana.png")}
            />
          </View>
        ...
        <View style={styles.imageviews}>
          <View style={styles.shadowview}>
            <TouchableOpacity onPress={() => navigation.navigate("Details")}>
              <ImageBackground
                style={{ width: 238, height: 344 }}
                source={require("../assets/images/yogurt_with_fruits_small.png")}
              >
